...
$sql = "SELECT * FROM boots_typen where boots_typ_id = 5";
...
if (isset($_POST['buchungsenden'])) {
  ...
  $sqlPreisProWocheHS = "SELECT preis_pro_woche_hs FROM boots_typen WHERE boots_typ_id = 5";
  $sqlPreisProTagHS = "SELECT preis_pro_tag_hs FROM boots_typen WHERE boots_typ_id = 5";
  $sqlPreisProWocheNS = "SELECT preis_pro_woche_ns FROM boots_typen WHERE boots_typ_id = 5";
  $sqlPreisProTagNS = "SELECT preis_pro_tag_ns FROM boots_typen WHERE boots_typ_id = 5";
  $sqlKaution = "SELECT kaution FROM boots_typen WHERE boots_typ_id = 5";
  ...
  if (
    ...
    $schranke = false;
    $db = mysqli_connect('db5000232553.hosting-data.io', 'dbu387591', 'brun#ITPM8', 'dbs227125');
    $sqlAbfrageBelegt = "SELECT id_17 FROM belegt WHERE datum between '$startDatumDB' and '$endDatumDB'";
    foreach ($db->query($sqlAbfrageBelegt) as $row) {
      if ($row['id_17'] != null) { //Wenn Boot buchbar ist --> Buchungsformular.php
        $boots_id = 18;
        break;
      } else {
        $boots_id = 17;
    ...
    if ($schranke == false) {
      $sqlAbfrageBelegt = "SELECT id_18 FROM belegt WHERE datum between '$startDatumDB' and '$endDatumDB'";
      foreach ($db->query($sqlAbfrageBelegt) as $row) {
        if ($row['id_18'] != null) { //Wenn Boot buchbar ist --> Buchungsformular.php
          $boots_id = 19;
          break;
        } else {
          $boots_id = 18;
    ...
    if ($schranke == false) {
      $sqlAbfrageBelegt = "SELECT id_19 FROM belegt WHERE datum between '$startDatumDB' and '$endDatumDB'";
      foreach ($db->query($sqlAbfrageBelegt) as $row) {
        if ($row['id_19'] != null) { //Wenn Boot buchbar ist --> Buchungsformular.php
          $boots_id = '';
          break;
        } else {
          $boots_id = 19;
    ...
    switch ($boots_id) {
      case 17:
        $tabelle_boots_id = "id_17";
        break;
      case 18:
        $tabelle_boots_id = "id_18";
        break;
      case 19:
        $tabelle_boots_id = "id_19";
        break;
    }
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img class="d-block w-100" src="../img/yachten/bavaria_cruiser_32_1.png" alt="First slide">
            </div>
            <div class="carousel-item">
              <img class="d-block w-100" src="../img/yachten/bavaria_cruiser_32_2.png" alt="Second slide">
            </div>
            <div class="carousel-item">
              <img class="d-block w-100" src="../img/yachten/bavaria_cruiser_32_3.png" alt="Third slide">
            </div>
          </div>
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-20">
                      ...
                      <script type="text/javascript">
                          ...
                          $pdo = new PDO('mysql:host=db5000232553.hosting-data.io;dbname=dbs227125', 'dbu387591', 'brun#ITPM8');
                          // Statement
                          $sql = "SELECT * FROM belegt where id_17 IS NOT NULL and id_18 IS NOT NULL and id_19 IS NOT NULL";
...
<div class="container">
  <p>
    Die Bavaria Cruiser 32 ist eine sportliche 10 meter lange Segelyacht mit modernem Loftcharakter. 
    Es handelt sich um eine extrem praktische Yacht, mit vielen soliden und funktionellen Details, wie der riesigen aufklappbaren Badeplattformen oder dem tiefen, geschützten Cockpit, in dem sich auch bei Seegang gut aufgehoben fühlt. 
    Zudem vermittelt sie noch Spaß am Segeln. 
    Wer bis jetzt Bavaria-Yachten nicht mochte, sollte der frischen Cruiser 32 eine Chance geben. 
    Trotz 1 ½ Meter Wellenhöhe, sprintet die kleine Yacht leichtfüßig los.
  </p>
  <p>
    Unter Deck gibt es klassisches Design in Mahagoni sind verschiedene Hölzer wählbar, die hohen Bordwände schaffen Platz in der Kajüte. 
    Zwei Kabinen sind serienmäßig, wobei die hintere sehr geräumig ist, so dass sich zwei Erwachsene gut organisieren können. 
    Alle Schotten, Stinger und möbelgruppen sind aufwändig an laminiert, wer bei Seegang unter Deck sitzt hört keinen Mucks. 
    Kein Knarren oder Knirschen. Stauräume gibt es ausreichend und in der Pantry fehlt es nicht an Platz.
  </p>
</div>
