...
$sql = "SELECT * FROM boots_typen where boots_typ_id = 3";
...
if (isset($_POST['buchungsenden'])) {
  ...
  $sqlPreisProWocheHS = "SELECT preis_pro_woche_hs FROM boots_typen WHERE boots_typ_id = 3";
  $sqlPreisProTagHS = "SELECT preis_pro_tag_hs FROM boots_typen WHERE boots_typ_id = 3";
  $sqlPreisProWocheNS = "SELECT preis_pro_woche_ns FROM boots_typen WHERE boots_typ_id = 3";
  $sqlPreisProTagNS = "SELECT preis_pro_tag_ns FROM boots_typen WHERE boots_typ_id = 3";
  $sqlKaution = "SELECT kaution FROM boots_typen WHERE boots_typ_id = 3";
  ...
  if (
    ...
    $schranke = false;
    $db = mysqli_connect('db5000232553.hosting-data.io', 'dbu387591', 'brun#ITPM8', 'dbs227125');
    $sqlAbfrageBelegt = "SELECT id_9 FROM belegt WHERE datum between '$startDatumDB' and '$endDatumDB'";
    foreach ($db->query($sqlAbfrageBelegt) as $row) {
      if ($row['id_9'] != null) { //Wenn Boot buchbar ist --> Buchungsformular.php
        $boots_id = 10;
        break;
      } else {
        $boots_id = 9;
    ...
    if ($schranke == false) {
      $sqlAbfrageBelegt = "SELECT id_10 FROM belegt WHERE datum between '$startDatumDB' and '$endDatumDB'";
      foreach ($db->query($sqlAbfrageBelegt) as $row) {
        if ($row['id_10'] != null) { //Wenn Boot buchbar ist --> Buchungsformular.php
          $boots_id = 11;
          break;
        } else {
          $boots_id = 10;
    ...
    if ($schranke == false) {
      $sqlAbfrageBelegt = "SELECT id_11 FROM belegt WHERE datum between '$startDatumDB' and '$endDatumDB'";
      foreach ($db->query($sqlAbfrageBelegt) as $row) {
        if ($row['id_11'] != null) { //Wenn Boot buchbar ist --> Buchungsformular.php
          $boots_id = 12;
          break;
        } else {
          $boots_id = 11;
    ...
    if ($schranke == false) {
      $sqlAbfrageBelegt = "SELECT id_12 FROM belegt WHERE datum between '$startDatumDB' and '$endDatumDB'";
      foreach ($db->query($sqlAbfrageBelegt) as $row) {
        if ($row['id_12'] != null) { //Wenn Boot buchbar ist --> Buchungsformular.php
          $boots_id = '';
          break;
        } else {
          $boots_id = 12;
    ...
    switch ($boots_id) {
      case 9:
        $tabelle_boots_id = "id_9";
        break;
      case 10:
        $tabelle_boots_id = "id_10";
        break;
      case 11:
        $tabelle_boots_id = "id_11";
        break;
      case 12:
        $tabelle_boots_id = "id_12";
        break;
    }
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img class="d-block w-100" src="../img/yachten/amiga_henk_27_1.png" alt="First slide">
            </div>
            <div class="carousel-item">
              <img class="d-block w-100" src="../img/yachten/amiga_henk_27_2.png" alt="Second slide">
            </div>
            <div class="carousel-item">
              <img class="d-block w-100" src="../img/yachten/amiga_henk_27_3.png" alt="Third slide">
            </div>
          </div>
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-20">
                      ...
                      <script type="text/javascript">
                          ...
                          $pdo = new PDO('mysql:host=db5000232553.hosting-data.io;dbname=dbs227125', 'dbu387591', 'brun#ITPM8');
                          // Statement
                          $sql = "SELECT * FROM belegt where id_9 IS NOT NULL and id_10 IS NOT NULL and id_11 IS NOT NULL and id_12 IS NOT NULL";
...
<div class="container">
  <p>
    Hausboot unter Segeln - Die familientaugliche 8 Meter lange Tourenyacht zeichnet als rassig und leistungsstark aus, dabei ist es das Komfortmaß, das die Henk 27 auszeichnet. 
    Sie begeistert zwar nicht mit sportlicher Agilität, ist dafür aber ein sicherer Hort für die ganze Familie. 
    Einfach zu bedienen, sinnvoll ausgestattet und unter Deck komfortabel. 
    Sie gilt als unangefochtenes Raumwunder. 
    Zwischen Vorschiff, WC-Raum und der Pantry wirkt es nirgendwo eng und immer großzügig, funktional und freundlich.
  </p>
</div>
